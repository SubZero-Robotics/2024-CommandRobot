...
void DriveSubsystem::Drive(units::meters_per_second_t xSpeed,
  ...
  //   } else {
  //     directionSlewRate = 500.0;  // some high number that means the slew
  //     rate
  ...
  //     } else {
  //       m_currentTranslationDir =
  //           SwerveUtils::WrapAngle(m_currentTranslationDir +
  //           std::numbers::pi);
  ...
  //   ConsoleLogger::getInstance().logVerbose("DriveSubsystem", "set prev time
  //   = %f", m_prevTime);
  ...
  // ConsoleLogger::getInstance().logInfo("DriveSubsystem", "Current rotation
  // %f",
  //                                      m_currentRotation);
