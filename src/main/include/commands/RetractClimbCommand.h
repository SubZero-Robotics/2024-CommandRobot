...
class RetractClimbCommand
    : public frc2::CommandHelper<frc2::Command, RetractClimbCommand> {
 public:
  ...
  void Execute() override {
    isFinished = !(m_leftClimb->GetIsMovingToPosition() ||
                   m_rightClimb->GetIsMovingToPosition());
  }
